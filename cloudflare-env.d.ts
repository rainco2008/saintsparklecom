/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a659791fb0f0cd5658478b3cc036e668)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		R2: R2Bucket;
		D1: D1Database;
		VECTORIZESAINTSPARKLE: VectorizeIndex;
		DIRECTORY_AI_QUEUE: Queue;
		DIRECTORY_EMBEDDING_QUEUE: Queue;
		DIRECTORY_CACHE_QUEUE: Queue;
		DIRECTORY_SITEMAP_QUEUE: Queue;
		ASSETS: Fetcher;
